                            ...
                            <div className="margin">
                                <div className="site-info">
                                    <div id="navigation2">
                                        ...
                                        <Link className="navbar-brand" to="/contact"><p style={{ backgroundColor: "white" }}>Cowboy Care LLC<br />1560 Johnston Street<br />Wheatland, WY 82201<br /><br />307-269-0655</p></Link>
                                    </div>
                                </div>
                                <NewHead />
                            <div className="Body">
